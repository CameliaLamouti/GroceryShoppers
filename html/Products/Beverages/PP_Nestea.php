...
<body>
    ...
    <main class="container">
        ...
        <div class="left-column">
          <img class="shop-item-image" src="../../../Images/nestea.jpg" alt="">
        </div>
        ...
        <div class="product-description">
          <h1 class="shop-item-title">Nestea</h1>
          <p>
    ...
    <div class="product-price">
      <span class="shop-item-price" >$2.99/pack</span>
      <div>
