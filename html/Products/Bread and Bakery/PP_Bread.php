...
<body>
    ...
    <main class="container">
        ...
        <div class="left-column">
          <img class="shop-item-image"  src="../../../Images/Bread.jpg" alt="">
        </div>
        ...
        <div class="product-description">
          <h1 class="shop-item-title" >Bread</h1>
          <p>
              <h3></br>Description: Fresh baked bread from Montreal Bakery.</h3>
    ...
    <div class="product-price">
      <span class="shop-item-price">$2.00/pack</span>
      <div>
