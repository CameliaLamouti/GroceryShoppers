...
<body>
    ...
    <main class="container">
        ...
        <div class="left-column">
          <img class="shop-item-image" src="../../../Images/baguette.jpeg" alt="">
        </div>
        ...
        <div class="product-description">
          <h1 class="shop-item-title">Baguettes</h1>
          <p>
              <h3></br>Description: Fresh baked baguettes from Montreal.</h3>
    ...
    <div class="product-price">
      <span class="shop-item-price" >$3.00/pack</span>
      <div>
