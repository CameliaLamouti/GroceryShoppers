...
<body>
    ...
    <main class="container">
        ...
        <div class="left-column">
          <img class="shop-item-image" src="../../../Images/BurgerBuns.jpg" alt="">
        </div>
        ...
        <div class="product-description">
          <h1 class="shop-item-title">Burger Buns</h1>
          <p>
              <h3></br>Description: Burger buns from Montreal.</h3>
    ...
    <div class="product-price">
      <span class="shop-item-price">$4.99/pack</span>
      <div>
