...
<body>
    ...
    <main class="container">
        ...
        <div class="left-column">
          <img class="shop-item-image" src="../../../Images/beef.jpg" alt="">
        </div>
        ...
        <div class="product-description">
          <h1 class="shop-item-title">Beef</h1>
          <p>
              <h3></br>Description: Imported from Mexico & Australia</h3>
              <h3></br>Nutritional Information</h3>
                <li>Calories: 250</li>
                <li>Total Fat: 15g</li>
                <li>Saturated fat: 0.5g</li>
                <li>Cholestorol: 90mg</li>
                <li>Sodium: 72mg</li>
                <li>Potassium: 320mg</li>
    ...
    <div class="product-price">
      <span class="shop-item-price">$10.00/lb</span>
      <div>
