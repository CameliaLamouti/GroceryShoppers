...
<body>
    ...
    <main class="container">
        ...
        <div class="left-column">
          <img  class="shop-item-image" src="../../../Images/tuna.jpg" alt="">
        </div>
        ...
        <div class="product-description">
          <h1 class="shop-item-title">Tuna</h1>
          <p>
              <h3></br>Description: Imported from Italy</h3>
              <h3></br>Nutritional Information</h3>
                <li>Calories: 130</li>
                <li>Total Fat: 1.3g</li>
                <li>Saturated fat: 0.4g</li>
    ...
    <div class="product-price">
      <span class="shop-item-price">$3.80/lb</span>
      <div>
