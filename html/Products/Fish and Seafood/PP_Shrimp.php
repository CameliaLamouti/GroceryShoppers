...
<body>
    ...
    <main class="container">
        ...
        <div class="left-column">
          <img class="shop-item-image" src="../../../Images/shrimp.jpg" alt="">
        </div>
        ...
        <div class="product-description">
          <h1 class="shop-item-title">Shrimp</h1>
          <p>
              <h3></br>Description: Imported from United States</h3>
              <h3></br>Nutritional Information</h3>
                <li>Calories: 80</li>
                <li>Total Fat: 0.3g</li>
                <li>Saturated fat: 0.2g</li>
                <li>Cholestorol: 190mg</li>
                <li>Sodium: 125mg</li>
    ...
    <div class="product-price">
      <span class="shop-item-price">$13.99/lb</span>
      <div>
