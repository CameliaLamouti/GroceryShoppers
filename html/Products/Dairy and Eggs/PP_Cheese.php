...
<body>
    ...
    <main class="container">
        ...
        <div class="left-column">
          <img class="shop-item-image" src="../../../Images/cheese.jpg" alt="">
        </div>
        ...
        <div class="product-description">
          <h1 class="shop-item-title" >Cheese</h1>
          <p>
              <h3></br>Description: Imported from France</h3>
              <h3></br>Nutritional Information</h3>
                <li>Calories: 400</li>
                <li>Total Fat: 30g</li>
                <li>Saturated fat: 17g</li>
                <li>Cholestorol: 105mg</li>
                <li>Sodium: 630mg</li>
                <li>Potassium: 101mg</li>
                <li>Total Carbohydrate: 1.5g</li>
                <li>Sugar: 10g</li>
                <li>Protein: 30g</li>
    ...
    <div class="product-price">
      <span class="shop-item-price" >$6.00/lb</span>
      <div>
        ...
        <select name="Type">
          <option value="Swiss">Type</option>
